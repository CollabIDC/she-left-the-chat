...
const planningTools = [
  ...
  { emoji: "🎒", title: "Packing List Builder", desc: "Answer a few questions. Get a list built for your trip, not everyone else's.", live: true, button: "BUILD MY LIST", href: "/resources/packing-list-builder" },
...
const comingSoon = [
  ...
  { emoji: "📋", title: "What I Learned About Visas", desc: "An honest overview of the options, what I researched, and what nobody told me upfront.", live: true, button: "READ IT", href: "/resources/what-i-learned-about-visas" },
  ...
  { emoji: "💰", title: "The Banking and Money Guide", desc: "Opening accounts, transferring money, and avoiding fees. The stuff nobody explains clearly.", live: true, button: "READ IT", href: "/resources/banking-and-money-guide" },
